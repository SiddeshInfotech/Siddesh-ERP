-- =============================================================================
-- Migration 37: Fix save_inward to set created_by for generated barcodes
--
-- Generated barcodes were missing created_by, causing them to appear without a
-- "Generated By" / "Scanned By" user in the UI before they were first scanned.
-- =============================================================================
